                    ...
                    <CardContent className="p-3 sm:p-4">
                        <div className="flex items-center gap-2 sm:gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-[10px] sm:text-xs text-slate-500">Total Events</p>
                            </div>
                        </div>
                    </CardContent>
                </Card>
                    ...
                    <CardContent className="p-3 sm:p-4">
                        <div className="flex items-center gap-2 sm:gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-[10px] sm:text-xs text-slate-500">Active Roles</p>
                            </div>
                        </div>
                    </CardContent>
                </Card>
                    ...
                    <CardContent className="p-3 sm:p-4">
                        <div className="flex items-center gap-2 sm:gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-[10px] sm:text-xs text-slate-500">Top Action</p>
                            </div>
                        </div>
                    </CardContent>
                </Card>
                            ...
                            <div className="flex gap-2 w-max">
                                {(['all', 'prescription', 'appointment', 'lab_order', 'order', 'child', 'auth'] as FilterType[]).map((type) => (
                                    <button
                                        ...
                                        className={`px-3 py-1.5 rounded-lg text-xs sm:text-sm font-medium whitespace-nowrap transition-all ${filterType === type
                            ...
                            {Object.entries(groupedLogs).map(([date, dateLogs]) => (
                                <div key={date}>
                                    ...
                                    <div className="sticky top-0 bg-slate-50 px-3 sm:px-4 py-2 border-b border-slate-100">
                                        <p className="text-xs sm:text-sm font-semibold text-slate-700">{date}</p>
                                    ...
                                    {dateLogs.map((log) => {
                                        ...
                                        return (
                                            <div
                                                key={log.id}
                                                className="flex items-start gap-3 p-3 sm:p-4 hover:bg-slate-50 transition-colors"
                                            >
                                                {/* Icon */}
